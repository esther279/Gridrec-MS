...
%     recons = iradonfast_v2(double(sinogramder),...
%         theta,'linear','derivative','Han',size(sinogramder,1),filtertomo);
%     recons = iradonfast_v2(double(sinogramder),theta,'linear','derivative','Ram-Lak',size(sinogramder,1),1);
    recons = iradonfast_v2(double(sinogramder), theta, size(sinogramder,1),1);
    if ~isempty(cliplow)
